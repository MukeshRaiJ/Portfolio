      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-[#ffd966] max-w-2xl mx-auto">
            Ready to embark on a cosmic journey? We're here to guide you through the stars. Let's connect!
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <ContactInfo icon={Rocket} title="Space Station" description="Orbital Platform Alpha" />
            <ContactInfo icon={Star} title="Coordinates" description="LAT: 28.5728° N, LON: 80.6490° W" />
            <ContactInfo icon={Mail} title="Subspace Comm" description="captain@cosmic-voyages.space" />
          </motion.div>
